use {
    ...
    libc::{
        ...
        socklen_t, xdp_mmap_offsets, xdp_umem_reg, AF_XDP, SOCK_RAW, SOL_SOCKET, SOL_XDP, XDP_COPY,
...
// socket options for busy-polling:
// SO_BUSY_POLL allows setting a timeout (in µs) for busy-polling on the socket,
// SO_BUSY_POLL_BUDGET sets how many packets can be processed in one busy-polling cycle,
// SO_PREFER_BUSY_POLL gives preference to busy-polling over interrupt-driven processing
